...
<?php
	...
	$row = mysql_fetch_array((mysql_query($sql)));
			...
			header("Location:second_transcript.php?msg=1");
    ...
    <tr>
      <td height="235" align="center" valign="middle"><table width="758" border="0" cellpadding="0" cellspacing="0">
        ...
        <table width="848" border="0" cellpadding="0" cellspacing="1">
          <tr>
            <td colspan="6" align="center" valign="middle" bgcolor="#993300"><h1><strong>ND 2 FIRST SEMESTER</strong> RESULT</h1></td>
          </tr>
          <tr>
            <td colspan="6" align="center" valign="middle">&nbsp;</td>
          </tr>
          <tr>
            <td width="132" align="center" valign="middle" bgcolor="#CCCCCC"><strong>COURSES</strong></td>
            <td width="286" align="center" valign="middle" bgcolor="#CCCCCC"><strong>COURSE TITTLE</strong></td>
            <td width="80" align="center" valign="middle" bgcolor="#CCCCCC"><strong>UNITS</strong></td>
          ...
          <tr>
            ...
            <?php
		$c=0;
			  $sql = "SELECT *FROM score WHERE matricno='$matric' AND semester='fs' AND level='ND 2' order by id asc;";
...
*/  ?>
			...
			<?php if ($score <40 )  echo "F"; if (($score >=40) && ($score <=44 ))echo "E"; if (($score >=45) && ($score <=49)) echo "D"; if (($score >=50) && ($score <=59)) echo "C"; if (($score >=60) && ($score <=69)) echo "B"; if (($score >=70) && ($score <=100)) echo "A"; if ($score >=100) echo "undefined" ?></td>
        ...
        <table width="848" border="0" cellpadding="0" cellspacing="1">
          <tr>
            <td colspan="6" align="center" valign="middle" bgcolor="#993300"><h1><strong>ND 2 SECOND SEMESTER</strong> RESULT</h1></td>
          </tr>
          <tr>
            <td colspan="6" align="center" valign="middle">&nbsp;</td>
          </tr>
          ...
          <tr>
            ...
            <?php
		$c=0;
			  $sql = "SELECT *FROM score WHERE matricno='$matric' AND semester='ss' AND level='ND 2' order by id asc;";
			    $query=mysql_query($sql) or die(mysql_error());
...
*/  ?>
        ...
        <td align="center" valign="middle" colspan="6">&nbsp;</td>              </tr>
           ...
           <tr>
           <td align="center"><strong><span style="color:blue">CGPA :</span></strong></td>  </span> <td align="left" valign="middle" colspan="5"><span style="color:red"><strong><?php  echo $overall=$show['UnitPoint']/$show['TotalUnit'] ?></strong></span></td> 
